...
def objective(trial):
    ...
    attention_blocks = trial.suggest_categorical('attention_blocks', [1, 2, 3, 4, 5, 6, 7, 8])
    ...
    noise_timesteps = trial.suggest_int('noise_timesteps', 3, 100)
    inference_timesteps = trial.suggest_int('inference_timesteps', 2, min(15, noise_timesteps-1))
...
if __name__ == '__main__':
    ...
    if not should_save_on_remote_db():
